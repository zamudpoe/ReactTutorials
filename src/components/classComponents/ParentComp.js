...
class ParentComp extends Component {
  ...
  componentDidMount () {
    console.log('\n\t%cDespues de 8 segs cambiaremos el estado name por "Engel"', 'color: teal; font-size: 1.5em;')

    setInterval(() => {
      this.setState({
        name: 'engel'
      }, console.log('\n\t%cHey!!, Ya pasaron 4 segs! y si el estado no ha cambiado no se re-renderizara el componente puro , de lo contrario shouldComponentUpdate regresara TRUE debido a sus (SC) qeu detectaran que las props o el state tuvieron cambios  ', 'color: red; font-size: 1.4em;'))
    }, 4000)
  }
    ...
    return (
      <div>
        ...
        */}
        ...
        {/* <MemoComp name={this.state.name} styles={styles}/> */}
      </div>
    )
  }
}
