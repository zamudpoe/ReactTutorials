...
class LifeCycleB extends Component {
  ...
  shouldComponentUpdate = () => {
    console.log('%c\tLifeCycleB %cshouldComponentUpdate', 'color: green; font-Size: 1.5em;', 'color: orange; font-size:1.5em;')
    return true
  }

  getSnapshotBeforeUpdate = (prevProps, prevState) => {
    console.log('%c\tLifeCycleB %cgetSnapshotBeforeUpdate', 'color: green; font-Size: 1.5em;', 'color: orange; font-size:1.5em;')
    return null
  }

  componentDidUpdate = () => {
    console.log('%c\tLifeCycleB %ccomponentDidUpdate', 'color: green; font-Size: 1.5em;', 'color: orange; font-size:1.5em;')
  }
