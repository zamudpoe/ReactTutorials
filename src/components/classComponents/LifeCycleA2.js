...
/* Componentes */
import LifeCycleB from '../classComponents/LifeCycleB2'
...
class LifeCycleA extends Component {
  constructor(props) {
    ...
    console.log('%c\tLifeCycleA Constructor', 'color: green; font-Size: 1em;')
  }

  static getDerivedStateFromProps = (props, state) => {
    console.log('%c\tLifeCycleA getDerivedStateFromProps', 'color: green; font-Size: 1em;')
    return null
  }

  static getDerivedStateFromError = (error) => {
    console.log('%c\tLifeCycleA getDerivedStateFromError', 'color: green; font-Size: 1em;')
  ...
  shouldComponentUpdate = () => {
    console.log('%c\tLifeCycleA %cshouldComponentUpdate', 'color: green; font-Size: 1.5em;', 'color: orange; font-size:1.5em;')
    return true
  }

  getSnapshotBeforeUpdate = (prevProps, prevState) => {
    console.log('%c\tLifeCycleA %cgetSnapshotBeforeUpdate', 'color: green; font-Size: 1.5em;', 'color: orange; font-size:1.5em;')

    return null
  }

  componentDidUpdate = () => {
    console.log('%c\tLifeCycleA %ccomponentDidUpdate', 'color: green; font-Size: 1.5em;', 'color: orange; font-size:1.5em;')
  }
  ...
  render () {
    ...
    return (
      <div>
        ...
        <button onClick= { this._changeState } >Change Statte</button>
